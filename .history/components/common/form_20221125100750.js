...
export default function Form({ handleLoadRecords, editRow }) {
  ...
  let [payment, setPayment] = useState(editRow ? editRoow?.payment : 0);
  let [client, setClient] = useState(editRow ? editRow?.client : 0);
  ...
  return (
    <div className="grid grid-cols-3 gap-5">
      ...
      <Button color="blue" disabled={submitting} onClick={() => createRecord()}>
