...
export default function MainScreen() {
  ...
  return (
    <div className="flex flex-col w-full pt-6 space-y-10">
      ...
      <CustomModal open={openModal} setOpen={(v)=>setOpenModal(v)} title='Do you want to delete this record?' customLable='Yes, delete' content='The action you are about to do is irreversible!'/>
    </div>
  );
}
